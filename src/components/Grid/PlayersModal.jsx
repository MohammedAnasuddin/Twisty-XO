        ...
        <div className=" fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              <div>
                {
                  mode == "vsComputer" ? <PlayerInput label="Player Name" value={player_2_Name} onChange={(e) => {setPlayerTwoName(e.target.value)}}  /> 
                  :
                   (
                    <>
                    <PlayerInput label="Player-1" value={player_1_Name} onChange={(e) => {setPlayerOneName(e.target.value)}}/>
                    <PlayerInput label="Player-2" value={player_2_Name} onChange={(e) => {setPlayerTwoName(e.target.value)}}/>
                    </>
                   )
